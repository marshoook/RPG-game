...
elixer = Item("Elixer", "elixer", " Fully restores HP/MP od one party member", 9999)
hielixer = Item ("MegaElixer", "elixer", "Fully restores party's HP/Mp", 9999)

grenade = Item ( "Grenade", "attacks", "Deals 500 Damage", 500)
...
player1 = Person("Rajan      :",3260, 132, 300, 34, player_spells, player_items)
player2 = Person("Sumeet     :",4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Nikhil     :",3089, 174, 288, 34, player_spells, player_items)

enemy1 = Person ("Frieza   :", 1250, 130, 560, 325, enemy_spells, [])
enemy2= Person ("Jiren    :",12000, 701, 525, 25, enemy_spells, [])
...
while running:
    ...
    for player in players:
        ...
        if index == 0:
            ...
            if item.type == "potion":
                ...
                if enemies[enemy].get_hp() ==0:
                    print(bcolors.OKBLUE +  enemies[enemy].name.replace(" ", "") + " has died." + bcolors.ENDC )
                    del enemies[enemy]
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            print(bcolors.OKBLUE + enemy.name.replace(" ","") + " attacks " + players[target].name.replace(" ","") + "for", enemy_dmg , " points of damage!" + bcolors.ENDC)
        
        elif enemy_choice == 1:5
